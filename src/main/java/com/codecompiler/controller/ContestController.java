...
public class ContestController {
	...
	@GetMapping("/fetchAllUploadedQuetions")
	public ResponseEntity<Object> fetchAllUploadedQuetions(@RequestParam(value = "contestId") String contestId){
		log.info("All Uploaded Quetions : And contestId = " + contestId);
		try {
			 List<MCQ> mcq=contestService.findAllUploadedQuetions(contestId);
			 if(mcq!=null)
