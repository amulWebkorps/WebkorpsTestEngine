 ...
 * 
 * import com.codecompiler.entity.Question; import
 * com.codecompiler.entity.Student; import com.codecompiler.helper.Helper;
 * import com.codecompiler.service.QuestionService;
 * 
 * //@Controller public class QuestionController {
 * 
 * @Autowired QuestionService qs; String contestLevel = null;
 * 
 * @RequestMapping(value = "/question/upload", headers =
 * "content-type=multipart/*", method = RequestMethod.POST) public
 * ResponseEntity<?> upload(@RequestParam("file") MultipartFile
 * file, @RequestParam("level") String level) { contestLevel = level; if
 * (Helper.checkExcelFormat(file)) { // true try { //this.qs.save(file); } catch
 * (Exception e) { e.printStackTrace(); } return
 * ResponseEntity.ok(contestLevel);
 * 
