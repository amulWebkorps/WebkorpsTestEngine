...
public class QuestionController {
    ...
    public ResponseEntity<Object> addSelectedAvailableQueToContest(@RequestBody Map<String, List<String>> questionIdList) {
        logger.info("addSelectedAvailableQueToContest :: started with questionIdList size: {}", questionIdList.size());
    ...
    public ResponseEntity<Object> addSelectedAvailableMCQToContest(@RequestBody Map<String, List<String>> MCQIdList) {
        logger.info("addSelectedAvailableMCQToContest :: started with MCQIdList size: {}", MCQIdList.size());
    ...
    @PutMapping("admin/deleteQuestion")
    public ResponseEntity<Object> updateQuestionStatus(@RequestBody ArrayList<String> contestAndQuestionId) {
        logger.info("updateQuestionStatus :: started with contestAndQuestionId: {}", contestAndQuestionId);
    ...
    @PutMapping("admin/deleteMcqQuestion")
    public ResponseEntity<Object> updateMcqQuestionStatus(@RequestBody ArrayList<String> contestAndMcqQuestionId) {
        logger.info("updateMcqQuestionStatus :: started with contestAndMcqQuestionId: {}", contestAndMcqQuestionId);

        mcqService.saveMcqQuestionOrContest(contestAndMcqQuestionId);

        logger.info("updateMcqQuestionStatus :: saveMcqQuestionOrContest saved successfully");
